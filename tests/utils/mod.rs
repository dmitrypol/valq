...
pub(crate) fn start_server_with_module(module_name: &str, port: u16) -> anyhow::Result<ChildGuard> {
...
pub(crate) fn get_server_connection(port: u16) -> anyhow::Result<Connection> {
...
fn get_module_path(module_name: &str) -> anyhow::Result<String> {
